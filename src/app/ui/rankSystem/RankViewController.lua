...
function RankViewController:showPlayer()
    ...
    self._Panel_player_t:getChildByName("childModel"):setVisible(false)
    ...
    local listHandler = function(index, widget, model, data)
        ...
        widget:getChildByName("BitmapFontLabel_rank_vip"):setText(tostring(data.vipLevel))
        if data.vipLevel == 0 then
            widget:getChildByName("BitmapFontLabel_rank_vip"):setVisible(false)
            widget:getChildByName("Image_player_vip"):setVisible(false)
        else
            widget:getChildByName("BitmapFontLabel_rank_vip"):setVisible(true)
            widget:getChildByName("Image_player_vip"):setVisible(true)
        end
...
function RankViewController:showGuild()
    ...
    self._Panel_guild_t:getChildByName("childModel"):setVisible(false)
    --现在所在页数
    Functions.initLabelOfString(self._Text_page_num_t,tostring(self.TypePage).."/"..tostring(self.MaxPage))
