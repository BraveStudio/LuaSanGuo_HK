...
function UnionDonatePopView:onInitUI()
	...
	self._Text_lei_ji_text_t = self.csbNode:getChildByName("Panel_fb_2"):getChildByName("Panel_but"):getChildByName("Panel_ban_1"):getChildByName("Text_lei_ji_text")
	...
	self._Text_zi_jin_text_t = self.csbNode:getChildByName("Panel_fb_2"):getChildByName("Panel_but"):getChildByName("Panel_ban_1"):getChildByName("Text_zi_jin_text")
...
--    local str2 = string.format(LanguageConfig.language_Union_40, UnionData:getguildActif())
    Functions.initLabelOfString(self._Text_lei_ji_num_t, UnionData:getplayerActif(), self._Text_zi_jin_1_t, UnionData:getguildActif())
end
