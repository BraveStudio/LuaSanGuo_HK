...
function UnionButFunctionPopView:onInitUI()
	...
	self._Button_but_function_7_t = self.csbNode:getChildByName("Panel_but_function_10"):getChildByName("Button_but_function_7")
	self._Button_but_function_7_t:onTouch(Functions.createClickListener(handler(self, self.onButton_but_function_7Click), "zoom"))
end
...
--@auto code Button_but_function_7 btFunc
function UnionButFunctionPopView:onButton_but_function_7Click()
    Functions.printInfo(self.debug,"Button_but_function_7 button is click!")
    --全员邮件
    self._controller_t:openChildView("app.ui.popViews.UnionUpLevelPopView")
end
--@auto code Button_but_function_7 btFunc end
