...
function MailTwoPopView:onInitUI()
	...
	self._Sprite_nengliang_7_t = self.csbNode:getChildByName("Panel_two_page"):getChildByName("Panel_nengliang_7"):getChildByName("Sprite_nengliang_7")
	...
	self._Panel_gongxian_9_t = self.csbNode:getChildByName("Panel_two_page"):getChildByName("Panel_gongxian_9")
	self._Sprite_gongxian_9_t = self.csbNode:getChildByName("Panel_two_page"):getChildByName("Panel_gongxian_9"):getChildByName("Sprite_gongxian_9")
	self._Text_gongxian_num_9_t = self.csbNode:getChildByName("Panel_two_page"):getChildByName("Panel_gongxian_9"):getChildByName("Text_gongxian_num_9")
    ...
    if self.param.eventAttr.m_mtype == 2 then
        ...
        for i=1, #items do
            ...
            if item.itype == 4 then
                ...
                elseif item.id == -10 then--国战的俸禄
                    self.MicroItem = self.MicroItem + 1
                    self._Panel_gongxian_9_t:setVisible(true)
                    self._Text_gongxian_num_9_t:setText(item.count)
                else
                    --道具
    ...
    for i = 1, #items do
        ...
        if item.itype == 4 then
            ...
            elseif item.id == -9 then--国战的俸禄
                ...
                self._Text_fenglu_num_8_t:setText(item.count)
            elseif item.id == -10 then--公会战贡献
                self.MicroItem = self.MicroItem - 1
                self._Panel_gongxian_9_t:setPosition(self.itemX, self.itemY)
                self._Text_gongxian_num_9_t:setText(item.count)
            else
