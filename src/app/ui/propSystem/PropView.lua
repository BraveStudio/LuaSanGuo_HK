...
function PropView:onInitUI()
	...
	self._tils_t = self.csbNode:getChildByName("main"):getChildByName("propListPanel"):getChildByName("propInfBg"):getChildByName("heroSoulInfPanel"):getChildByName("tils")
