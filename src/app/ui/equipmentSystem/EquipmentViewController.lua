...
--    local faf, rdFaf = 0, 0
    ...
    local embattleHeroMarks = EmbattleData:getEmbattleMarks(embattleType)
    local tatal ,attack,hp,fas,faf = Functions.getHeroFightAttrs({heroMark = heroMark,partHeroMarks = EmbattleData.PartHeroMark,equipMarks = equipMarks,embattleHeroMarks=embattleHeroMarks})
    -- for i = 1, 4 do
