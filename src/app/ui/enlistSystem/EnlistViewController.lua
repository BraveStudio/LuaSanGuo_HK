...
function EnlistViewController:onDidLoadView()
	...
	self._Image_bao_icon_1_t = self.view_t.csbNode:getChildByName("main"):getChildByName("Panel_main"):getChildByName("Image_yuanBao"):getChildByName("Image_bao_icon_1")
	...
	self._Image_bao_icon_2_t = self.view_t.csbNode:getChildByName("main"):getChildByName("Panel_main"):getChildByName("Image_yuanBao"):getChildByName("Image_bao_icon_2")
...
function EnlistViewController:onDisplayView()
    ...
    Functions.loadImageWithWidget(self._Image_bao_icon_1_t, "property_63.png") 
    Functions.loadImageWithWidget(self._Image_bao_icon_2_t, "property_63.png") 
    ...
    local strCount = tostring(PropData:getPropNumOfId(79)).."/"..tostring(g_SampleNewCfg.TenZml)
    self._Text_bao_string_2_t:setText(strCount)
...
function EnlistViewController:updateUI()
    ...
    if EnlistData.m_sampleGNum <= 0 then
        self:showBaoTime()
        local strCount = tostring(PropData:getPropNumOfId(79)).."/"..tostring(g_SampleNewCfg.zml)
        Functions.initLabelOfString( self._Text_bao_string_1_t, strCount)
        local strCount2 = tostring(PropData:getPropNumOfId(79)).."/"..tostring(g_SampleNewCfg.TenZml)
        Functions.initLabelOfString( self._Text_bao_string_2_t, strCount2)
    else
        Functions.initLabelOfString( self._Text_bao_string_1_t, LanguageConfig.language_Enlist_3)
        Functions.initLabelOfString( self._Text_bao_time_t, LanguageConfig.language_Enlist_2)
    end
