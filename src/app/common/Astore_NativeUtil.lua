...
elseif device.platform == "ios" then
    ...
    print("loaccccccccccccccccccccc")
end
...
function NativeUtil:GameCenterLogin()
    PromptManager:openHttpLinkPrompt()
...
function NativeUtil._JniBackCall(msg)
    ...
    for k,v in pairs(msgTable) do
        ...
        elseif k == "API_Gateway" then
            ...
            print("GameState.storeAttr.curNonce_s:" .. GameState.storeAttr.curNonce_s )
