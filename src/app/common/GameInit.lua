...
elseif G_SDKType == 7 then 
    VipData = require("app.gameData.Qstore_VipData")
else
...
EquipmentData:init()
--初始化将魂数据
HeroSoulData = require("app.gameData.HeroSoulData")
HeroSoulData:init()
--初始化战斗配置表
...
--七日狂欢
CarnivalData = require("app.gameData.CarnivalData")
CarnivalData:init()
...
--魂晶商城
SoulShopData = require("app.gameData.SoulShopData")
SoulShopData:init()

--节日狂欢
HolidayData = require("app.gameData.HolidayData")
HolidayData:init()
