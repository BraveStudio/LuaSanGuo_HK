...
UnionInfoData.eventAttr.allActif = 0        --公会目前贡献
UnionInfoData.eventAttr.guild_level = 0     --公会等级
...
function UnionInfoData:getAllActif()
    return UnionInfoData.eventAttr.allActif
end

function UnionInfoData:getGuild_level()
    return UnionInfoData.eventAttr.guild_level
end
