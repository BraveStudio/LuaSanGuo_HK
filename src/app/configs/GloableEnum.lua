...
JumpType = 
{
   ...
   HeroSoulCtrToHeroSoulPop = 8,
   HeroSoulCtrToHeroSoulInf = 9,
   HeroSoulInfToHeroSoulPop = 10,
   HeroSoulPopToHeroSoulInf = 11,
   HeroSoulInfToHeroSoulUpgrade = 12,
   HeroSoulUpgradeToHeroSoulPop = 13,
}
